...
const LEAD_STATUS_COLUMNS = [
  'cold_email_sent', 'cold_email_sent_at', 'followup1_sent', 'followup1_sent_at', 'followup2_sent', 'followup2_sent_at',
  'followup3_sent', 'followup3_sent_at', 'replied', 'replied_at', 'reply_sentiment', 'whatsapp_sent', 'whatsapp_sent_at',
  'no_whatsapp', 'no_whatsapp_at', 'email_invalid', 'email_invalid_at', 'phone_invalid', 'phone_invalid_at',
  'converted', 'converted_at', 'linkedin_sent', 'linkedin_sent_at', 'sms_sent', 'sms_sent_at',
...
async function restoreLeadMerge(snapshot: any) {
  ...
  const { status, tags, social_profiles, score, band, ...leadFields } = loser
