  ...
  return (
    <div className="card p-6">
      ...
      <p className="mb-4 text-xs text-base-400">
        Used for new deals unless overridden per-deal, and as the Revenue dashboard's default Display Currency
        (deals in other currencies are converted using live exchange rates for reporting only).
      </p>
