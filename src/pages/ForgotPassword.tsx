...
export function ForgotPassword() {
  ...
  const mutation = useMutation({
    mutationFn: () => passwordResetRequestsApi.create(email.trim()),
  })
        ...
        {mutation.isSuccess ? (
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-sm text-base-400">
              If an account exists with this email, a request has been sent to your admin. They'll provide you a new
              password soon.
            </p>
          ...
          <>
            <div className="mb-8 flex flex-col items-center text-center">
              ...
              <h1 className="text-xl font-semibold text-base-100">Forgot Password</h1>
              <p className="mt-1 text-sm text-base-400">
                Enter your account's email and your admin will be notified to reset it.
              </p>
            </div>
