...
import { ShieldAlert, ArrowLeft, AlertCircle, Loader2, MailCheck } from 'lucide-react'
import { mfaResetRequestsApi } from '@/lib/api'
import { usePlatformBranding } from '@/hooks/usePlatformBranding'

export function MfaLockedOut() {
  usePlatformBranding()
  const [email, setEmail] = useState('')

  const mutation = useMutation({
    mutationFn: () => mfaResetRequestsApi.create(email.trim()),
  })
      ...
      <div className="card relative w-full max-w-sm p-8 animate-slideUp">
        {mutation.isSuccess ? (
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-xl font-semibold text-base-100">Request sent</h1>
            <p className="mt-2 text-sm text-base-400">
              If an account exists with this email, a request has been sent to your admin. They'll help you regain
              access soon.
            </p>
          ...
          <>
            <div className="mb-8 flex flex-col items-center text-center">
              ...
              <h1 className="text-xl font-semibold text-base-100">Locked out of Two-Factor Authentication?</h1>
              <p className="mt-1 text-sm text-base-400">
                Enter your account's email and your admin will be notified to clear your two-factor authentication
                so you can sign back in and set up a new authenticator.
              </p>
            </div>
